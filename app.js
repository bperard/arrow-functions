...
// The window object of the browser.
// 3. Explain why "this" is different when an arrow function is used.
// An arrow function takes the scope it's wrapped in, so an arrow function that isn't wrapped in anything will refer to the outer scope.